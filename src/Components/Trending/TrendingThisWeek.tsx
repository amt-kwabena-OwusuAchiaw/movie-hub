...
export const TrendingThisWeek = () => {
    ...
    interface trends{
     ...
     const trending:string =`https://api.themoviedb.org/3/trending/all/week?api_key=5eb7eaa6c60e68b38ecb9bcb17fee24f`
  ...
  return (
    <div>  
        {/* <div><h1 style={{textAlign:'center'}}>This Week</h1></div> */}
         <MainApperance>
             {trend && trend.map((c:c )=> (
