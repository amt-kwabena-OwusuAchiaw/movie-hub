...
export const MovieNowPlaying = () => {
    ...
    const popular:string = `https://api.themoviedb.org/3/movie/now_playing?api_key=5eb7eaa6c60e68b38ecb9bcb17fee24f&language=en-US&include_adult=false&include_video=false&page=${page}&with_genres=${createdGenre}` ;
      interface genre{
            id:number,
            name:string
    ...
    return (
      <div style={{backgroundColor:'#141212'}}>
        <Header/>
        <div><h1 style={{textAlign:'center', color:'orange'}}> Now Playing</h1></div>
